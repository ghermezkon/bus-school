...
export class LessonListPage {
    ...
    //---------------------------------------------------------------------
    constructor(private _http: HttpService, private _loader: LoaderService, private navParams: NavParams, private navCtrl: NavController) {
        this.getParams();
    ...
    ionViewWillLoad() {
        this._loader.show().present().then(() => {
            this.lesson_list = this._http.find_exam_lesson_by_teacher_name(this.teacher_name);
            this._loader.hide();
        })
    }
    //---------------------------------------------------------------------
